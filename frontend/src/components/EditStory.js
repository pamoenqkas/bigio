    ...
    <>
      ...
      <div className="absolute h-full inset-y-0 right-0 mt-24 p-5 w-full xl:w-4/5 border-l-2">
        <div className="ml-4 mt-3">
          ...
          <p className="text-4xl font-bold text-gray-700 mt-5">Edit Story</p>
                ...
                <div className="w-full xl:w-1/2">
                  <label className="block">
                    ...
                    <input
                      ...
                      placeholder="Title"
                      className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-purple-500 focus:ring-1 "
                    ></input>
                  </label>
                </div>
                <div className="w-full xl:w-1/2">
